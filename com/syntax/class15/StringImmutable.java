...
public class StringImmutable {
	public static void main(String[] args) {
		...
		str.toUpperCase();  // new object gets created but one is referring to that object
		System.out.println(str); // original str did not changed
		...
		System.out.println("Value of str2 after assigmnet=" + str2);
