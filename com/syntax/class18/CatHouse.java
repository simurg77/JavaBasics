...
public class CatHouse {
	public static void main(String[] args) {
		...
		cat1.name = "Jessy";
		cat1.age = 8;
		cat1.color ="grey"; // accesing instance variable and assigning value
		// to acces static variables we use name of the class where they were declared
		...
		Cat.tail = false;      // this is best way to acces static variables
//		
